...
const textNode = document.createTextNode('Zufälliges Bild mit Javascript anzeigen')
...
clickMeButton.appendChild(buttonText)
clickMeButton.classList.add('buttonStyle')

// Image
const image = document.createElement('img')
let imgSource /*  = data[0]['download_url'] */
...
clickMeButton.addEventListener('click', () => {
    ...
    imgSource = data[randomNum]['download_url']
